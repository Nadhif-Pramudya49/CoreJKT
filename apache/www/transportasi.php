...
<body>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card shadow-sm feature-box h-100 info-card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text small text-secondary">Menampilkan posisi real-time bus Transjakarta, MRT, dan LRT untuk perencanaan perjalanan yang lebih akurat.</p>
                        <a href="#" class="btn btn-sm mt-2" style="background-color: #0d6efd; color: white;">Mulai Lacak</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card shadow-sm feature-box h-100 info-card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text small text-secondary">Memudahkan pembelian dan penggunaan tiket transportasi publik secara digital yang cepat dan aman.</p>
                        <a href="#" class="btn btn-sm mt-2" style="background-color: var(--blue-soft); color: white;">Beli Tiket</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card shadow-sm feature-box h-100 info-card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text small text-secondary">Informasi lengkap mengenai jadwal keberangkatan, rute, dan tarif untuk semua jenis angkutan umum di Jakarta.</p>
                        <a href="#" class="btn btn-sm mt-2" style="background-color: #0d6efd; color: white;">Cek Jadwal Rute</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                ...
                <ul class="list-group shadow-sm">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <a href="#" class="btn btn-sm btn-outline-secondary">Lihat CCTV</a>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Layanan Pelaporan Kendaraan Darurat (Ambulans, Pemadam) - *Live Tracking*
                        <a href="#" class="btn btn-sm btn-outline-danger">Lapor Darurat</a>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
    ...
    <footer class="text-white py-4" style="background-color: #051025 !important;">
        <div class="container text-center">
            <p>&copy; 2024 CoreJKT - Layanan Transportasi Publik DKI Jakarta.</p>
        </div>
    </footer>
