            ...
            <div class="col-lg-4 col-md-6">
                <div class="card shadow-sm feature-box h-100 info-card">
                    <div class="card-body text-center">
                        ...
                        <a href="javascript:void(0)" onclick="fiturBelumTersedia()" class="btn btn-sm mt-2"
                            style="background-color: var(--blue-soft); color: white;">
                            Beli Tiket
                        </a>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card shadow-sm feature-box h-100 info-card">
                    <div class="card-body text-center">
                        ...
                        <a href="transportasi_rute.php" class="btn btn-sm mt-2"
                            style="background-color: #0d6efd; color: white;">Cek Jadwal
                            Rute</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                ...
                <ul class="list-group shadow-sm">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <a href="lalin_rekayasa.php" class="btn btn-sm btn-outline-secondary">Cek Info Lalin</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <script>
        function fiturBelumTersedia() {
            Swal.fire({
                ...
                html: `
            <p><strong>Layanan Beli Tiket</strong> sedang dalam tahap pengembangan.</p>
            <p>Kami lagi <b>ngebut</b> biar cepat rilis 🚀</p>
        `,
